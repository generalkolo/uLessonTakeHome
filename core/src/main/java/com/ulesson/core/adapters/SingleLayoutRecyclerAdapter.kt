package com.ulesson.core.adapters
...
abstract class SingleLayoutRecyclerAdapter <B: ViewDataBinding, D> (
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) = (holder as AppBaseViewHolder<D>).bindItem(items[position])
